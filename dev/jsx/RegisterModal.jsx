...
const RegisterLink = props => <a onClick={props.onClick} href="javascript:{}" class="ms_btn">register now</a>
const LoginLink = props => <p>Already Have An Account? <a href="#myModal1" data-toggle="modal" class="ms_modal hideCurrentModel">login here</a></p>
